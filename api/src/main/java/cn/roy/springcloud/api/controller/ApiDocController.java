...
public class ApiDocController {
    ...
    public ResultData importApiFromFile(@ApiParam(name = "filePath", value = "包含项目所有接口数据的JSON格式的文件",
            required = true, type = "String", example = "c:/api-docs.json")
    ...
    public ResultData importApiFromUrl(@ApiParam(name = "swaggerUrl", value = "可获取项目的所有接口JSON格式的URL",
            required = true, type = "String", example = "http://localhost:8080/v2/api-docs")
                                       @RequestParam String swaggerUrl) throws IOException, URISyntaxException {
    ...
    public ResultData exportApiDoc(@ApiParam(name = "filePath", value = "包含需要导出相关数据的接口列表Excel文件",
            required = true, type = "String", example = "C:\\Users\\Roy Z Zhou\\Desktop\\接口列表.xlsx")
